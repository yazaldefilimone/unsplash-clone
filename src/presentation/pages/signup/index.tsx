...
import { ILoginUserUseCase, ISignupUserUseCase } from '@/domain/usecases/user';
...
export const SignUp: FunctionComponent<SignUpProps> = ({ signupUserUseCase, loginUserUseCase }) => {
